function score = Neural_Network_batch_stepsizeRestrictedSGPTL_MONK(numHidden1, lambda, beta, delta_multiplicator, R, rho)
    %% ===================================
    % LOADING TRAINING DATA (500 patterns)
    % ====================================
    % per MONK
    Dataset_TR = readtable('../monk/monks-2.train', ...
    'FileType','text', ...
    'Delimiter',' ', ...
    ...
    filename = sprintf( ...
        'models/SGPTL/monk/stepsizeRestrictedSGPTL_Monk2-h1-%d-lambda-%g-beta-%g-R-%g-rho-%g-deltaMult-%g_%d.mat', ...
