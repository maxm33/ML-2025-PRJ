function score = Neural_Network_batch_stepsizeRestrictedSGPTL_matrix(numHidden1, numHidden2, lambda, beta, delta_multiplicator, R, rho, alpha_def)
    %% ===================================
    ...
    for fold = 1:k
        ...
        while epoch < maxEpochs
            ...
            d_vec = alpha_def * g + (1 - alpha_def) * d_prev;
            d = (norm(d_vec)^2);
    
            numeratore = max(0, loss - (f_ref - delta));

            epsilon = 1e-8;
            beta_eff = min(beta, alpha_def);
