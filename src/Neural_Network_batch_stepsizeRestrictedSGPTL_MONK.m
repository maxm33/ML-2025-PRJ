function score = Neural_Network_batch_stepsizeRestrictedSGPTL_MONK(numHidden1, numHidden2, lambda, beta, delta_multiplicator, R, rho)
    %% ===================================
    % LOADING TRAINING DATA (500 patterns)
    % ====================================
    % per MONK
    Dataset_TR = readtable('../monk/monks-1.train', ...
    'FileType','text', ...
    'Delimiter',' ', ...
    ...
    %% Carico test set
    Dataset_TS = readtable('../monk/monks-1.test', ...
    'FileType','text', ...
    'Delimiter',' ', ...
    'MultipleDelimsAsOne',true, ...
    'ReadVariableNames',false, ...
    ...
    filename = sprintf( ...
        'models/SGPTL/deflectionRestrictedSGPTL_Monk1-h1-%d-h2-%d-lambda-%g-beta-%g-R-%g-rho-%g-deltaMult-%g_%d.mat', ...
